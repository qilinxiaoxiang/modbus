 ...
 */
public class MainModbusMasterResponseProcessor extends AbstractModbusProcessor implements ModbusMasterResponseProcessor {
	private static final InternalLogger LOGGER = InternalLoggerFactory.getInstance(MainModbusMasterResponseProcessor.class);
	public MainModbusMasterResponseProcessor(short transactionIdentifierOffset) {
